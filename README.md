...
The Java version used by p4a is the version required for gradle version used. For p4a master, you need a jar built with Java 13 (or perhaps 11, or possibly 15) and have that Java version installed.
